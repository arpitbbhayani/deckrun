...
export const SNIPPETS: Snippet[] = [
  ...
  { id: "act-theme",    group: "Actions", label: "Theme",                   hint: "Fourteen palettes with their own fonts and backdrops. Arrows preview live, enter keeps one.", syntax: "", action: "theme",    keys: "Cmd Shift L" },
